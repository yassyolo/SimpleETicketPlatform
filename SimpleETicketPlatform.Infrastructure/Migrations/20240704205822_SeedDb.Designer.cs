...
namespace SimpleETicketPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20240704205822_SeedDb")]
            ...
            modelBuilder.Entity("SimpleETicketPlatform.Infrastructure.Data.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 8, 13, 0, 0, 0, 0, DateTimeKind.Local),
                            MovieCategory = 3,
                            Name = "Titanic",
                            ...
                            Price = 12.99m,
                            ProducerId = 1,
                            StartDate = new DateTime(2024, 7, 4, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EndDate = new DateTime(2024, 8, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            MovieCategory = 4,
                            Name = "365 Days",
                            ...
                            Price = 9.99m,
                            ProducerId = 2,
                            StartDate = new DateTime(2024, 6, 14, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            EndDate = new DateTime(2024, 9, 12, 0, 0, 0, 0, DateTimeKind.Local),
                            MovieCategory = 1,
                            Name = "Mr. and Mrs. Smith",
                            PhotoURL = "https://m.media-amazon.com/images/M/MV5BYjY2NzUxNjgtNjJhNy00NTA4LTlmNzItYzQ4MDdjNWYxZjkwXkEyXkFqcGdeQXVyMTEwMTY3NDI@._V1_FMjpg_UX1000_.jpg",
                            Price = 14.99m,
                            ProducerId = 3,
                            StartDate = new DateTime(2024, 7, 24, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            EndDate = new DateTime(2024, 10, 12, 0, 0, 0, 0, DateTimeKind.Local),
                            MovieCategory = 3,
                            Name = "The Wolf of Wall Street",
                            PhotoURL = "https://m.media-amazon.com/images/M/MV5BMjIxMjgxNTk0MF5BMl5BanBnXkFtZTgwNjIyOTg2MDE@._V1_.jpg",
                            Price = 19.99m,
                            ProducerId = 4,
                            StartDate = new DateTime(2024, 8, 3, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Price = 7.99m,
                            ProducerId = 5,
                            StartDate = new DateTime(2024, 10, 2, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            Price = 5.99m,
                            ProducerId = 6,
                            StartDate = new DateTime(2024, 7, 14, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
