...
namespace SimpleETicketPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20240807150743_addOrdersDate")]
    partial class addOrdersDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "35d3d6fa-c020-485b-aec0-8845468c4c01",
                            RoleId = "71b461ba-dc43-4d74-b70f-29499795bea8"
                        },
                        new
                        {
                            UserId = "f71a12d7-8b47-492c-8585-c5295875e01c",
            ...
            modelBuilder.Entity("SimpleETicketPlatform.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("FullName")
                        ...
                        .HasComment("Application user full name");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "db88240e-ec94-4ccb-a9d8-31d82dd1a0ca",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            FullName = "Admin",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEAe3oiBq6Vxl6rjuw8ZnvNkBy7J1C3qO8TcxW3pTvTgMZ6nMawAw7cSiiAoDIy4YxQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "cafb0281-c7a9-422a-8393-0e0da32d8811",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7570406b-91a1-4266-bc33-1399d832d92e",
                            Email = "user@gmail.com",
                            EmailConfirmed = true,
                            FullName = "User",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAECdYI5FG+vTTNkh0OPVL5JVWa9RH0OUP3NtE+CXthMo73EQmkCEj7O1zMtmnMuG++A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2d4a85c8-0857-4e14-950e-fa70df9c796f",
                            TwoFactorEnabled = false,
                            UserName = "user"
                        });
                });
            ...
            modelBuilder.Entity("SimpleETicketPlatform.Infrastructure.Data.Models.Movie", b =>
                {
                    ...
                    b.Property<int>("MovieCategoryId")
                        .HasColumnType("int")
                        .HasComment("Movie category identifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 9, 16, 0, 0, 0, 0, DateTimeKind.Local),
                            MovieCategoryId = 3,
                            Name = "Titanic",
                            ...
                            Price = 12.99m,
                            ProducerId = 1,
                            StartDate = new DateTime(2024, 8, 7, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EndDate = new DateTime(2024, 9, 6, 0, 0, 0, 0, DateTimeKind.Local),
                            MovieCategoryId = 4,
                            Name = "365 Days",
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 10, 16, 0, 0, 0, 0, DateTimeKind.Local),
                            MovieCategoryId = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 11, 15, 0, 0, 0, 0, DateTimeKind.Local),
                            MovieCategoryId = 3,
                            Name = "The Wolf of Wall Street",
                            PhotoURL = "https://m.media-amazon.com/images/M/MV5BMjIxMjgxNTk0MF5BMl5BanBnXkFtZTgwNjIyOTg2MDE@._V1_.jpg",
                            Price = 19.99m,
                            ProducerId = 4,
                            StartDate = new DateTime(2024, 9, 6, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            EndDate = new DateTime(2024, 12, 25, 0, 0, 0, 0, DateTimeKind.Local),
                            MovieCategoryId = 2,
                            Name = "Maleficent",
                            PhotoURL = "https://upload.wikimedia.org/wikipedia/en/5/55/Maleficent_poster.jpg",
                            Price = 7.99m,
                            ProducerId = 5,
                            StartDate = new DateTime(2024, 11, 5, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            Price = 5.99m,
                            ProducerId = 6,
                            StartDate = new DateTime(2024, 8, 17, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
            ...
            modelBuilder.Entity("SimpleETicketPlatform.Infrastructure.Data.Models.MovieCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("Name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Movie category name");

                    b.HasKey("Id");

                    b.ToTable("MovieCategories");

                    b.HasComment("Movie category entity");
            ...
            modelBuilder.Entity("SimpleETicketPlatform.Infrastructure.Data.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .HasColumnType("datetime2")
                        .HasComment("Order date when made");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SimpleETicketPlatform.Infrastructure.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SimpleETicketPlatform.Infrastructure.Data.Models.Movie", b =>
                {
                    ...
                    b.HasOne("SimpleETicketPlatform.Infrastructure.Data.Models.MovieCategory", "MovieCategory")
                        .WithMany()
